...
export build_name=trojan2

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan2

# Design directory name
dirName=trojan2_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan2"
