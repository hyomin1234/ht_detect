...
export build_name=Trojan6

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan6

# Design directory name
dirName=trojan6_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan6"
