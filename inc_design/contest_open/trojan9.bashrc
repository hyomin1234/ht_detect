...
export build_name=Trojan9

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan9

# Design directory name
dirName=trojan9_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan9"
