...
export build_name=trojan1

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan1

# Design directory name
dirName=trojan1_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan1"
