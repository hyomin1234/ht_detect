...
export build_name=Trojan8

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan8

# Design directory name
dirName=trojan8_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan8"
