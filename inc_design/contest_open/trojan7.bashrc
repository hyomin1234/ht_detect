...
export build_name=Trojan7

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan7

# Design directory name
dirName=trojan7_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan7"
