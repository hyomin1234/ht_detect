...
export build_name=Trojan3

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan3

# Design directory name
dirName=trojan3_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan3"
