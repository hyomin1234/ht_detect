...
export build_name=Trojan4

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan4

# Design directory name
dirName=trojan4_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan4"
