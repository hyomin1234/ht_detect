...
export build_name=lfsr_counter

# RTL directory
export RTLDir=c:/HT_detect/00_contest/trojan_definition/trojan0

# Design directory name
dirName=trojan0_util${UTIL}_clk${CLK}
...
########### PATH FIX #######
# Explicit paths
baseDir="c:/HT_detect/designs/trojan0"
